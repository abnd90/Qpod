...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Sat Oct 24 08:29:36 2009
# Project:  Qpod.pro
# Template: app
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -lmp4v2 -lgpod -lgdk_pixbuf-2.0 -lgmodule-2.0 -ltag -lQtGui -L/usr/lib -L/usr/X11R6/lib64 -pthread -lpng -lfreetype -lgobject-2.0 -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtCore -lz -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lpthread
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
